...
public class OfficeControllerImpl implements OfficeController {
    ...
    public Response offices(@RequestBody OfficeView office) {
        return new Response("success", officeService.listOffices(office));
    }
    ...
    public Response offices() {
        return new Response("success", officeService.offices());
    }
    ...
    public Response getOfficeById(@PathVariable(value = "id") Long id) {
        return new Response("success", officeService.getOfficeById(id));
    }
    ...
    public Response updateOrganizaton(@RequestBody OfficeView office) {
    ...
    public Response deleteOrganizaton(@RequestBody OfficeView office) {
