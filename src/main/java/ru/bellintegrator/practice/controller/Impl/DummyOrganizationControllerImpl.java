...
public class DummyOrganizationControllerImpl implements DummyOrganizationController {
    ...
    private final DummyOrganizationService dummyService;

    @Autowired
    public DummyOrganizationControllerImpl(DummyOrganizationService dummyService) {
    ...
    public void organization(@RequestBody OrganizationView organizations) {
        dummyService.add(organizations);
    }
    ...
    public List<OrganizationView> organizations() {
        return dummyService.organizations();
    }
